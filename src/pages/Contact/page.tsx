...
export default function Contact() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    form.append("access_key", "1df4f85d-ff96-47e7-8afd-aa279ef7b652"); // Replace with your Web3Forms access key
      ...
      <section className="w-full px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-8">
            {/* Contact Info */}
            <div className="space-y-6 backdrop-blur-sm p-6 rounded-3xl border border-white/10 shadow-lg bg-gradient-to-br from-white/5 to-white/10 max-h-[600px] overflow-y-auto">
              <div>
            ...
            {/* Contact Form */}
            <div
              className={`backdrop-blur-xl p-6 rounded-3xl shadow-2xl border ${
                isDarkMode
