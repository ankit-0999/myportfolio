  ...
  const skillCategories: SkillCategory[] = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Express JS",
          icon: <Hexagon className="w-4 h-4 text-[#E10098]" />,
        },
        {
          name: "WebSocket",
          icon: <SiSocketdotio className="w-4 h-4 text-[#e1b800]" />,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Git & GitHub",
          icon: <GitBranch className="w-4 h-4 text-[#F05032]" />,
        },
        { name: "Vercel", icon: <SiVercel className="w-4 h-4 text-white" /> },
        { name: "Andaconda", icon: <SiAnaconda className="w-4 h-4 text-[#8dff64]" /> },
        { name: "PyCharm", icon: <SiPycharm className="w-4 h-4 text-[#61DAFB]" /> },
        {name:"Figma", icon:<Figma className="w-4 h-4 text-[#F24E1E]" />},
      ],
    },
    {
